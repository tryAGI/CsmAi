...
namespace CsmAi
{
    public partial class ImageTo3dClient
    {
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement s_ListImageTo3DSessionsSecurityRequirement0 =
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement[] s_ListImageTo3DSessionsSecurityRequirements =
            new global::CsmAi.EndPointSecurityRequirement[]
            {                s_ListImageTo3DSessionsSecurityRequirement0,
            };
        partial void PrepareListImageTo3DSessionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref int? page);
        partial void PrepareListImageTo3DSessionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            int? page);
        partial void ProcessListImageTo3DSessionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListImageTo3DSessionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CsmAi.LegacyImageTo3DListEnvelope> ListImageTo3DSessionsAsync(
            int? limit = default,
            int? page = default,
            global::CsmAi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListImageTo3DSessionsAsResponseAsync(
                limit: limit,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CsmAi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyImageTo3DListEnvelope>> ListImageTo3DSessionsAsResponseAsync(
            int? limit = default,
            int? page = default,
            global::CsmAi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListImageTo3DSessionsArguments(
            ...
            var __authorizations = global::CsmAi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListImageTo3DSessionsSecurityRequirements,
                operationName: "ListImageTo3DSessionsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListImageTo3DSessionsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CsmAi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListImageTo3DSessions",
                                methodName: "ListImageTo3DSessionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListImageTo3DSessionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListImageTo3DSessionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CsmAi.LegacyImageTo3DListEnvelope.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyImageTo3DListEnvelope>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CsmAi.LegacyImageTo3DListEnvelope.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
