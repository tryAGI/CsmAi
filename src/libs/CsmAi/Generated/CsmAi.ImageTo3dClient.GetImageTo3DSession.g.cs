...
namespace CsmAi
{
    public partial class ImageTo3dClient
    {
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement s_GetImageTo3DSessionSecurityRequirement0 =
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement[] s_GetImageTo3DSessionSecurityRequirements =
            new global::CsmAi.EndPointSecurityRequirement[]
            {                s_GetImageTo3DSessionSecurityRequirement0,
            };
        partial void PrepareGetImageTo3DSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sessionCode);
        partial void PrepareGetImageTo3DSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionCode);
        partial void ProcessGetImageTo3DSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetImageTo3DSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CsmAi.LegacyImageTo3DSessionEnvelope> GetImageTo3DSessionAsync(
            string sessionCode,
            global::CsmAi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetImageTo3DSessionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CsmAi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyImageTo3DSessionEnvelope>> GetImageTo3DSessionAsResponseAsync(
            string sessionCode,
            global::CsmAi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetImageTo3DSessionArguments(
            ...
            var __authorizations = global::CsmAi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetImageTo3DSessionSecurityRequirements,
                operationName: "GetImageTo3DSessionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::CsmAi.PathBuilder(
                                path: $"/image-to-3d-sessions/{sessionCode}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CsmAi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetImageTo3DSession",
                                methodName: "GetImageTo3DSessionAsync",
                                pathTemplate: "$\"/image-to-3d-sessions/{sessionCode}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetImageTo3DSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetImageTo3DSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CsmAi.LegacyImageTo3DSessionEnvelope.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyImageTo3DSessionEnvelope>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CsmAi.LegacyImageTo3DSessionEnvelope.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
