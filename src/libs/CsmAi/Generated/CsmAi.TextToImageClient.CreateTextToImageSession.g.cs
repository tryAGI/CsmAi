...
namespace CsmAi
{
    public partial class TextToImageClient
    {
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement s_CreateTextToImageSessionSecurityRequirement0 =
        ...
        private static readonly global::CsmAi.EndPointSecurityRequirement[] s_CreateTextToImageSessionSecurityRequirements =
            new global::CsmAi.EndPointSecurityRequirement[]
            {                s_CreateTextToImageSessionSecurityRequirement0,
            };
        partial void PrepareCreateTextToImageSessionArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::CsmAi.LegacyTextToImageRequest request);
        partial void PrepareCreateTextToImageSessionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::CsmAi.LegacyTextToImageRequest request);
        partial void ProcessCreateTextToImageSessionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTextToImageSessionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::CsmAi.LegacyTextToImageSessionEnvelope> CreateTextToImageSessionAsync(

            global::CsmAi.LegacyTextToImageRequest request,
            global::CsmAi.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateTextToImageSessionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::CsmAi.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyTextToImageSessionEnvelope>> CreateTextToImageSessionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTextToImageSessionArguments(
            ...
            var __authorizations = global::CsmAi.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTextToImageSessionSecurityRequirements,
                operationName: "CreateTextToImageSessionAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTextToImageSessionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::CsmAi.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateTextToImageSession",
                                methodName: "CreateTextToImageSessionAsync",
                                pathTemplate: "\"/tti-sessions\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTextToImageSessionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::CsmAi.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTextToImageSessionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::CsmAi.LegacyTextToImageSessionEnvelope.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::CsmAi.AutoSDKHttpResponse<global::CsmAi.LegacyTextToImageSessionEnvelope>(
                                ...
                                {
                                    throw global::CsmAi.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::CsmAi.LegacyTextToImageSessionEnvelope.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::CsmAi.LegacyTextToImageSessionEnvelope> CreateTextToImageSessionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::CsmAi.LegacyTextToImageRequest
            {
                Prompt = prompt,
                StyleId = styleId,
                Guidance = guidance,
            ...
            return await CreateTextToImageSessionAsync(
                request: __request,
                requestOptions: requestOptions,
