...
The CsmAi SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package CsmAi
```
...
using var client = new CsmAiClient(
    apiKey: Environment.GetEnvironmentVariable("CSMAI_API_KEY")!);
